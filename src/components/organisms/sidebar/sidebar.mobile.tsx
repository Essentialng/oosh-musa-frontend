...
const SidebarMobile = () => {
    ...
    const menuData = [
        {
            Title: "Home",
            Logo: <FaHome className="w-3 h-3 sm:group-hover:w-4 sm:group-hover:h-4 transition-all duration-500" />,
            link: ""
        },
        {
            Title: "Reel",
            Logo: <FaFire className="w-3 h-3 sm:group-hover:w-4 sm:group-hover:h-4 transition-all duration-500" />,
            link: "reel"
        },
        {
            Title: "Chat",
            Logo: <MdChat className="w-3 h-3 sm:group-hover:w-4 sm:group-hover:h-4 transition-all duration-500" />,
            link: "chat/1234"
        },
        {
            Title: "Profile",
            Logo: <FaUser className="w-3 h-3 sm:group-hover:w-4 sm:group-hover:h-4 transition-all duration-500" />,
            link: "profile/1234"
        },
        {
            Title: "Timeline",
        ...
        {
            Title: "Meeting",
            Logo: <FaMeetup className="w-3 h-3 sm:group-hover:w-4 sm:group-hover:h-4 transition-all duration-500" />,
            link: "meet"
        },
        {
            Title: "Planner",
            Logo: <TbCalendarEvent className="w-3 h-3 sm:group-hover:w-4 sm:group-hover:h-4 transition-all duration-500" />,
            link: "plan"
        },
        {
            Title: "News",
            Logo: <TbNewSection className="w-3 h-3 sm:group-hover:w-4 sm:group-hover:h-4 transition-all duration-500" />,
            link: "news"
        },
        {
            Title: "Live",
            Logo: <MdGroup className="w-3 h-3 sm:group-hover:w-4 sm:group-hover:h-4 transition-all duration-500" />,
            link: "live"
        }
    ];
    ...
    return (
        <div className="flex items-center justify-evenly w-full py-3">
            ...
            <div className="flex flex-col items-center cursor-pointer w-8 h-8" onClick={filterList}>
                <BsMenuApp className="" />
