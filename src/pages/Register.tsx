    ...
    <div className="w-screen sm:h-screen h-auto overflow-hidden flex flex-col sm:flex-row items-center justify-start">
      ...
      <section className="relative bg-gradient-to-br from-blue-800 to-cyan-500 sm:w-3/5 w-full sm:h-full h-full flex items-start sm:justify-center justify-start overflow-hidden">
        ...
        <div className="relative z-30 sm:mt-40 mt-20 text-white sm:px-20 px-10 pb-20 sm:pb-0 text-balance">
          <h1 className="sm:text-[2rem] text-[1.5rem] font-semibold mb-2">
            Join Us Today! 🌟
          </h1>
          <p>
            Experience the ultimate social media platform where you can create,
            share, connect, and chat all in one place. With the innovative
            spirit of our platform, its community feelings, its trending buzz,
            and personal chatting touch, you're set for an unparalleled social
            experience.
          </p>
          <p className="mt-14">
      ...
      <section className="text-black flex items-center justify-center flex-col sm:w-2/5 w-full">
        <h1 className="mb-6 mt-10 sm:mt-0 sm:text-3xl text-2xl font-semibold text-blue-400">
          Register
        </h1>
        <form
        ...
        >
          ...
          <FormInput
            required={true}
            icon={<FaMask className="text-blue-400 text-sm" />}
          ...
          <FormInput
            required={true}
            icon={<MdMailOutline className="text-blue-400 text-sm" />}
            placeholder="email"
            name="email"
            type="email"
            register={register}
          ...
          <FormInput
            required={true}
            icon={<FaLock className="text-blue-400 text-sm" />}
          ...
          <button
            type="submit"
            className="mt-4 px-16 py-2 rounded-full sm:text-2xl text-xl font-semibold text-white bg-gradient-to-tr from-blue-800 to-cyan-500 hover:bg-gradient-to-tl transition-all duration-500"
          >
